...
<a href="/docs/mattilsynet-kompasset-nb.pdf" aria-label="Last ned stategisk kompass som PDF" style={{ display: 'block' }}>
  <img src={kompasset} alt="" style={{ display: 'block', maxWidth: '100%' }} />
</a>
