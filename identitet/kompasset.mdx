...
import { FilePdfIcon, CompassRoseIcon } from '@phosphor-icons/react'
import { Card, Button, Details, Flex, Grid } from '../designsystem/react';

<Meta title="Identitet/Kompasset og roller" />

# <CompassRoseIcon /> Kompasset og roller

> For å bli opptre tydelige og enhetlig, må vi alle jobbe for de samme overordnede målene. Kompasset skal bidra til å samle oss, sette ord på hvem vi er og hva som er vår felles strategiske retning.

<Card as="figure" style={{ padding: 'var(--mtds-1)' }}>
