...
<a href="/docs/mattilsynet-kompasset-nb.pdf" className={styles.button} data-variant="secondary" download><FilePdf /> Bokmål</a>
<a href="/docs/mattilsynet-kompasset-nn.pdf" className={styles.button} data-variant="secondary" download><FilePdf /> Nynorsk</a>
<a href="/docs/mattilsynet-kompasset-en.pdf" className={styles.button} data-variant="secondary" download><FilePdf /> Engelsk</a>
</div>

### Last ned roller
<a href="/docs/mattilsynet-roller.pdf" className={styles.button} data-variant="secondary" download><FilePdf /> Bokmål</a>
