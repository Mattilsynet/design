...
import { encodeSVG } from './logo';
import logoNorsk from '../public/logo.svg?raw';
import logoEngelsk from '../public/logo-english.svg?raw';
import logoSamisk from '../public/logo-samisk.svg?raw';
...
<style dangerouslySetInnerHTML={{ __html: "span > svg:only-child { display: block; width: 50%; height: auto; margin-top: 2rem }" }}/>
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)' }}>
  <a href={encodeSVG(logoNorsk)} download="mattilsynet-logo.svg">
    <span dangerouslySetInnerHTML={{ __html: logoNorsk }} />
  ...
  <a href={encodeSVG(logoEngelsk)} download="mattilsynet-logo-engelsk.svg">
    <span dangerouslySetInnerHTML={{ __html: logoEngelsk }} />
  ...
  <a href={encodeSVG(logoSamisk)} download="mattilsynet-logo-samisk.svg">
    <span dangerouslySetInnerHTML={{ __html: logoSamisk }} />
