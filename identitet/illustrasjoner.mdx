...
<div className={styles.flex} data-justify="space-between" data-align="center">
  <h2 className="sbdocs-h2" style={{ margin: 0 }}>Illustrasjoner</h2>
  <a className={styles.button} href="https://design.mattilsynet.no/?path=/docs/designsystem-introduksjon--docs" data-arrow>Se hvordan installere i kode</a>
</div>
