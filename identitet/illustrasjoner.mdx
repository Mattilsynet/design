...
<Details>
  <Details.Summary>Illustrasjonsstil</Details.Summary>
...
<Details>
  <Details.Summary>Farger</Details.Summary>
...
<Flex data-justify="space-between" data-align="center">
  <h2 className="sbdocs-h2" style={{ margin: 0 }}>Illustrasjoner</h2>
  <Button href="https://design.mattilsynet.no/?path=/docs/designsystem-introduksjon--docs" data-arrow>Se hvordan installere i kode</Button>
</Flex>
