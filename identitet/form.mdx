...
<div className="$style.card">
  <div>
    <div className="$style.card__title">Øremerking av svin</div>
...
<div>
  <div className="`${$style.card} ${$style['card--light']}`" style="max-width: 18rem">
    <img alt="" src="./form-2.png" />
    <div>
      Aktuelt
      <div className="$style.card__title">Svinepest i Sverige &rarr;</div>
    </div>
  </div>
</div>*/}
