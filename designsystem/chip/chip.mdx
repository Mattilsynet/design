...
<Flex data-items="350">
  ...
  <Example data-color="success" text="Chips skal ligge etter hverandre og organisk brekke ned på neste linje." zoom="100%">
        <Flex data-gap="2">
        <label className={styles.chip}><input className={styles.input} type="radio" value="Laks" defaultChecked name="my-radio" />Laks</label>
        <label className={styles.chip}><input className={styles.input} type="radio" value="Rødspette" name="my-radio" />Rødspette</label>
        <label className={styles.chip}><input className={styles.input} type="radio" value="Sei" name="my-radio" />Sei</label>
        <label className={styles.chip}><input className={styles.input} type="radio" value="Torsk" name="my-radio" />Torsk</label>
        <label className={styles.chip}><input className={styles.input} type="radio" value="Ørret" name="my-radio" />Ørret</label>
