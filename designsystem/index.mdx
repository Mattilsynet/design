...
1. **Installer** `@mattilsynet/design` fra Mattilsynets [NPM organsiasjon](https://www.npmjs.com/package/@mattilsynet/design):
    <Tabs data-size="sm">
      ...
      <Tabs.Panel style={{ padding: 20 }}>
        <Button data-variant="primary" target="_blank" href="https://github.com/Mattilsynet/design/blob/next/clojure/README.md">Se egen README for Clojure <ArrowSquareOut /></Button>
      </Tabs.Panel>
    </Tabs>
