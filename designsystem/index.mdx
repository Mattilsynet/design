...
<style>{`u-tabs{--mtdsc-tabs-content-padding: 0}`}</style>
...
4. **Ta i bruk stiler**
    ...
    - **Nøst elementer** som f.eks.  `<dialog className={styles.dialog}><div className={styles.grid}>`, heller enn å kombinere flere designsystem-klasser på samme element
