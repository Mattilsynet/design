...
3. **Importer stiler** enten via JavaScript, CSS eller med TailwindCSS:
    <u-tabs class={styles.tabs} data-size="sm">
      ...
      <u-tabpanel>
        ...
        */
        @layer tailwind-base, ds, mt; /* Must be before loading @mattilsynet/design */
        ...
        @import url('@mattilsynet/design/styles.css'); /* Load @mattilsynet/design after Tailwind */
        ```
      </u-tabpanel>
    </u-tabs>
...
4. **Ta i bruk stiler**
    - **Størrelser kan endres** med `data-size="sm | md | lg"` kan brukes på *alle* HTML elementer - også HTML elementer uten designsystem-klasse
