...
## Kode
- Bruk klassen `togglegroup` på `<fieldset>` med `focusgroup="radiogroup"` og `aria-label="LABEL-PÅ-GRUPPEN"`
...
<Flex data-items="350">
  ...
  <div className={styles.grid}>
      <fieldset className={styles.togglegroup} aria-label="Mappe" focusgroup="radiogroup">
