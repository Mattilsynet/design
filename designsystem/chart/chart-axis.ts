...
const CSS_AXIS = styles.doughnut.split(" ")[0];

function handleAxisMutation(doughnuts: HTMLCollectionOf<SVGSVGElement>) {
...
onLoaded(() =>
	onMutation(document.documentElement, CSS_AXIS, handleAxisMutation),
);
