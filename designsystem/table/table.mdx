...
## Mobile: Divided (Eksperimentell)
- Legg `data-mobile="divided"` på `<table>` for todelt uttegning opp til `960px`
...
## Mobile: Spaced (Eksperimentell)
- Legg `data-mobile="spaced"` på `<table>` for todelt uttegning opp til `960px`
- **Merk:** todeling krever at du har importert javascript pakken: `import "@mattilsynet/design"`
