...
<div className="sbdocs-canvas-thumbnail">
  <a className={styles.button} data-arrow data-variant="primary" href="?path=/story/designsystem-table--mobile-scroll">Se scroll tabell i egen visning</a>
...
<div className="sbdocs-canvas-thumbnail">
  <a className={styles.button} data-arrow data-variant="primary" href="?path=/story/designsystem-table--mobile-divided">Se divided tabell i egen visning</a>
  <Canvas className="sbdocs-canvas--max-height" of={stories.MobileDivided} />
</div>
...
<div className="sbdocs-canvas-thumbnail">
  <a className={styles.button} data-arrow data-variant="primary" href="?path=/story/designsystem-table--mobile-spaced">Se spaced tabell i egen visning</a>
...
<div className="sbdocs-canvas-thumbnail">
  <a className={styles.button} data-arrow data-variant="primary" href="?path=/story/designsystem-table--mobile-stacked">Se stacked tabell i egen visning</a>
