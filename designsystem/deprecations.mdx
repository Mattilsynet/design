...
import { getPkgVersion, Wide } from '../.storybook/blocks';
import { ArrowUpRightIcon, ChatsCircleIcon, CheckCircleIcon, LightbulbIcon, GitBranchIcon } from "@phosphor-icons/react";
import { Alert, Badge, Card, Details, Divider, Flex, Grid, Group, Heading, Button, Tabs, Table, Prose } from './react'
import { styles } from './';
...
<Table data-size="sm">
  ...
  <Table.Tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>➡️ `class="styles.validation" data-field="description"` Klasse og attributt</Table.Td>
    </Table.Tr>
    <Table.Tr>
