...
- `Flex` støtter `data-break` for å forenkle et responsivit oppsett av `flex` med 3 barn
...
- **Merk:** Firefox støtter ikke dynamisk `order` *enda*, så der vil handlingene ligger under innholdet på små skjermer.
