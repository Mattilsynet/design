...
<Flex data-items="350">
  ...
  <Example data-color="success" text="Logo skal kun brukes i fargene som er definert i designsystemet." zoom="100%">
    ...
    <a className={styles.logo} href="https://mattilsynet.no" style={{ WebkitMaskBoxImage: "none" }} ></a>
  ...
  <Example data-color="danger" text="Ikke bruk Mattilsynets logo med andre farger enn definert i designsystemet." zoom="100%">
    ...
    {/* Overwrite Autoprefixer */}
    <a style={{ color: 'purple' }} className={styles.logo} href="https://mattilsynet.no" style={{ WebkitMaskBoxImage: "none" }}></a>
