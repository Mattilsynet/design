...
<Details>
<Details.Summary>Opplever at logoen bare blir en firkant?</Details.Summary>

Noen versjoner av [Autoprefixer](https://github.com/postcss/autoprefixer) er vell ivrig på å prefixe `mask`. Det er dessverre lite å gjøre med i `@mattilsynet/design`, men
det kan hjelpe å sette `style="-webkit-mask-box-image: none"` i din kode.
