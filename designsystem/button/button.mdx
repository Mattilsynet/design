...
- Bruk `data-anchor="top | bottom | left | right"` for å plassere handlingsmenyen
...
- Ved bruk av attributten `aria-pressed="true"` får knappen et sjekk-symbol
